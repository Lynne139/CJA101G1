...
public class MemberLoginController {
    ...
    public String showLoginPage(ModelMap model) {
        ...
        model.addAttribute("mainFragment", "front-end/member/memberLogin");
        return "index";
    }
    ...
    public String login(@RequestParam("memberEmail") String email,
        ...
        if (member == null || !member.getMemberPassword().equals(password)) {
            ...
            model.addAttribute("mainFragment", "front-end/member/memberLogin");
            model.addAttribute("fragmentName", "memberLoginFragment");
            return "index";
        }
    ...
    public String memberCenter(HttpSession session, ModelMap model) {
        ...
        model.addAttribute("mainFragment", "front-end/member/memberCenter");
        model.addAttribute("fragmentName", "memberCenterFragment");
        return "index";
    }
